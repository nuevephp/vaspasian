...
<tr id="page_<?php echo $child['id']; ?>" class="child">
		...
		<div class="page" style="padding-left: 4px;">
			<span class="w1">
				<?php if($child['has_children']){ ?>
					<img src="<?php echo vasp_theme(); ?>/images/spacer.png" width="16" height="16" alt="Create" />					<?php //echo html::image(array('src'=>'cms_assets/images/spacer.gif', 'alt'=>'Spacer', 'width' => '17', 'height'=>'17', 'align'=>'middle', 'class'=>'expander', 'id'=>$child['id'])); ?>				<?php } ?>
				<!-- <a href="<?php echo site_url('admin/page/subpage/'.$child['id']); ?>"> -->
					<img src="<?php echo vasp_theme(); ?>/images/page.png" width="16" height="16" alt="Page" />
	...
	<td class="modify pad">
		<a href="<?php echo site_url('admin/page/create/'.$child['id']); ?>">			<img src="<?php echo vasp_theme(); ?>/images/create.png" width="16" height="16" alt="Create" />			<?php //echo html::image(array('src'=>'cms_assets/images/create.png', 'alt'=>'Add', 'width' => '16', 'height'=>'16', 'align'=>'middle')); ?>		</a>
		<a href="<?php echo site_url('admin/page/edit/'.$child['id']); ?>">
			...
			<img src="<?php echo vasp_theme(); ?>/images/pencil.png" width="16" height="16" alt="Edit" />			<?php //echo html::image(array('src'=>'cms_assets/images/pencil.png', 'alt'=>'Edit', 'width' => '16', 'height'=>'16', 'align'=>'middle')); ?>		</a>
		<a href="<?php echo site_url('admin/page/delete/'.$child['id']); ?>">
			<img src="<?php echo vasp_theme(); ?>/images/delete.png" width="16" height="16" alt="Delete" />			<?php //echo html::image(array('src'=>'cms_assets/images/delete.png', 'alt'=>'Delete', 'width' => '16', 'height'=>'16', 'align'=>'middle')); ?>		</a>
	</td>
